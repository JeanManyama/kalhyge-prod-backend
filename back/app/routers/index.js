...
router.patch('/articles/objective', controllerWrapper(articleController.updateObjective));
...
router.get('/productions/articles', controllerWrapper(productionController.getByProductionArticle));
// HISTORIQUE DE PRODUCTION 
router.post('/productions/historique', controllerWrapper(productionController.getByProductionHistorique));
//SUPPRESION HISTORIQUE DE PRODUCTION
router.delete('/productions/historique', controllerWrapper(productionController.deletehistorique));
...
router.post('/productions/articles/:articleId(\\d+)/fetch', controllerWrapper(productionController.getByProductionArticleWithTime));

//----------------------Creation d'une production----------------------//
router.post('/productions/articles/:articleId', controllerWrapper(productionController.create));

//----------------------update d'une production----------------------/
router.patch('/productions/articles/:articleId/article', controllerWrapper(productionController.updateQuantity));

//----------------------update d'une production----------------------/
router.patch('/productions/articles/:articleId/machine', controllerWrapper(productionController.updateMachine));

//----------------------suppression d'une production----------------------//
router.delete('/productions/articles/:prodId', controllerWrapper(productionController.delete));
...
router.post('/productions/machines/:machineId(\\d+)', controllerWrapper(productionController.getByProductionMachine));


//----------------------La route qui nous donne les machines qui ont eu au moins une production Au cas où ----------------------//
router.get('/productions/machines', controllerWrapper(productionController.getAllMachine));
...
router.get('/productions/rejet/:timerId(\\d+)', controllerWrapper(rejetController.getAllRejects));
...
router.patch('/productions/rejet',(req, res, next)=> {controllerWrapper(rejetController.updateMachineOrArticleReject.bind(rejetController))(req, res, next)});
